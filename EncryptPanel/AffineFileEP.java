...
public class AffineFileEP extends JPanel {
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = fileChooser.showOpenDialog(AffineFileEP.this);
				...
				if (e.getActionCommand().equals("Encrypt")) {
					if (ptTextField.getText().isBlank() || keyATextField.getText().isBlank()
						...
						if (fileUploaded != true) {
							...
							int userChoice = dirChooser.showSaveDialog(AffineFileEP.this);
							if (userChoice == JFileChooser.APPROVE_OPTION) {
								...
								Affine affine = new Affine();
								try {
									affine.encryptFile(srcFile, key, destDir);
