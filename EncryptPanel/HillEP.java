...
public class HillEP extends JPanel {
	...
	public HillEP() {
		...
		top.setBorder(BorderFactory.createTitledBorder(topBD, "Thông tin - Mã hóa Hill"));
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = fileChooser.showOpenDialog(HillEP.this);
				...
				if(e.getActionCommand().equals("Encrypt")) {
					if(ptTextField.getText().isBlank() ||
						...
						int userChoice = dirChooser.showSaveDialog(HillEP.this);
						if(userChoice == JFileChooser.APPROVE_OPTION) {
							...
							Hill hill = new Hill();
							try {
								hill.encrypt(text, key, destDir);
								
								//Show result to Text Area
								txtArea.setText("Result");
								txtArea.append("\n" + hill.getEncryptedString());
								
								//Print key file
								File destFile = new File(destDir.getAbsolutePath() + "\\HillKey.txt");
