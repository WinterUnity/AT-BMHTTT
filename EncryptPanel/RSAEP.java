...
public class RSAEP extends JPanel {
	...
	public RSAEP() {
		...
		top.setBorder(BorderFactory.createTitledBorder(topBD, "Thông tin - Mã hóa RSA"));
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = fileChooser.showOpenDialog(RSAEP.this);
				...
				if (e.getActionCommand().equals("Load key")) {
					...
					int userChoice = keyFileChooser.showOpenDialog(RSAEP.this);
					if (userChoice == JFileChooser.APPROVE_OPTION) {
				...
				if (e.getActionCommand().equals("Encrypt")) {
					if (ptTextField.getText().isBlank() || keyTextField.getText().isBlank()) {
						...
						if (keyCreated != true) {
							...
							int userChoice = dirChooser.showSaveDialog(RSAEP.this);
							if (userChoice == JFileChooser.APPROVE_OPTION) {
								...
								// Encrypting
								try {
									rsa.encrypt(text, publicKey, destDir);
