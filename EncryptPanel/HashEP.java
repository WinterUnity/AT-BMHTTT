...
public class HashEP extends JPanel {
	...
	public HashEP() {
		...
		top.setBorder(BorderFactory.createTitledBorder(topBD, "Thông tin - Mã hóa Hash"));
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = fileChooser.showOpenDialog(HashEP.this);
				...
				if (e.getActionCommand().equals("Encrypt")) {
					if (ptTextField.getText().isBlank()) {
						...
						int userChoice = dirChooser.showSaveDialog(HashEP.this);
						if (userChoice == JFileChooser.APPROVE_OPTION) {
							...
							try {
								...
								String encryptedText = hash.hashText(text);
								...
								File destFile = new File(destDir.getAbsolutePath() + "\\HashText.txt");
