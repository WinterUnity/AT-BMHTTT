...
public class VigenereFileEP extends JPanel {
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = fileChooser.showOpenDialog(VigenereFileEP.this);
				...
				if (e.getActionCommand().equals("Upload Key")) {
					...
					int userChoice = keyFileChooser.showOpenDialog(VigenereFileEP.this);
					if (userChoice == JFileChooser.APPROVE_OPTION) {
				...
				if (e.getActionCommand().equals("Encrypt")) {
					if (ptTextField.getText().isBlank() || keyTextField.getText().isBlank()) {
						...
						if (fileUploaded != true) {
							...
							int userChoice = dirChooser.showSaveDialog(VigenereFileEP.this);
							if (userChoice == JFileChooser.APPROVE_OPTION) {
								...
								// Encrypting
								try {
									vigenere.encryptFile(srcFile, key, destDir);
