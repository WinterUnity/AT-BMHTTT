...
public class SubstitutionEP extends JPanel {
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = fileChooser.showOpenDialog(SubstitutionEP.this);
				...
				if(e.getActionCommand().equals("Encrypt")) {
					if(ptTextField.getText().isBlank() ||
						...
						int userChoice = dirChooser.showSaveDialog(SubstitutionEP.this);
						if(userChoice == JFileChooser.APPROVE_OPTION) {
