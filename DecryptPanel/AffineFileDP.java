...
public class AffineFileDP extends JPanel {
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = textFileChooser.showOpenDialog(AffineFileDP.this);
				...
				if (e.getActionCommand().equals("Load key")) {
					...
					int userChoice = keyFileChooser.showOpenDialog(AffineFileDP.this);
					if (userChoice == JFileChooser.APPROVE_OPTION) {
				...
				if (e.getActionCommand().equals("Decrypt")) {
					if (ctTextField.getText().isBlank() || keyATextField.getText().isBlank()
						...
						if (fileUploaded != true) {
							...
							int userChoice = dirChooser.showSaveDialog(AffineFileDP.this);
							if (userChoice == JFileChooser.APPROVE_OPTION) {
								...
								Affine affine = new Affine();
								try {
									affine.decryptFile(textFile, key, destDir);
