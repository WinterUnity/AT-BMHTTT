...
public class AffineDP extends JPanel {
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = textFileChooser.showOpenDialog(AffineDP.this);
				...
				if(e.getActionCommand().equals("Load key")) {
					...
					int userChoice = keyFileChooser.showOpenDialog(AffineDP.this);
					if(userChoice == JFileChooser.APPROVE_OPTION) {
				...
				if(e.getActionCommand().equals("Decrypt")) {
					if(ctTextField.getText().isBlank() ||
						...
						int userChoice = dirChooser.showSaveDialog(AffineDP.this);
						if(userChoice == JFileChooser.APPROVE_OPTION) {
