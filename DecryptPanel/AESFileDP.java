...
public class AESFileDP extends JPanel {
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = textFileChooser.showOpenDialog(AESFileDP.this);
				...
				if (e.getActionCommand().equals("Load key")) {
					...
					int userChoice = keyFileChooser.showOpenDialog(AESFileDP.this);
					if (userChoice == JFileChooser.APPROVE_OPTION) {
				...
				if (e.getActionCommand().equals("Decrypt")) {
					if (ctTextField.getText().isBlank() || keyTextField.getText().isBlank()) {
						...
						if (keyUploaded != true) {
							...
							int userChoice = dirChooser.showSaveDialog(AESFileDP.this);
							if (userChoice == JFileChooser.APPROVE_OPTION) {
								...
								// Decrypting
								try {
									aes.decryptFile(textFile, aesKey, destDir);
