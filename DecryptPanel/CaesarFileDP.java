...
public class CaesarFileDP extends JPanel {
		...
		ActionListener buttonListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getActionCommand().equals("Choose File")) {
					...
					int userChoice = textFileChooser.showOpenDialog(CaesarFileDP.this);
				...
				if (e.getActionCommand().equals("Load key")) {
					...
					int userChoice = keyFileChooser.showOpenDialog(CaesarFileDP.this);
					if (userChoice == JFileChooser.APPROVE_OPTION) {
				...
				if (e.getActionCommand().equals("Decrypt")) {
					if (ctTextField.getText().isBlank() || keyTextField.getText().isBlank()) {
						...
						if (fileUploaded != true) {
							...
							int userChoice = dirChooser.showSaveDialog(CaesarFileDP.this);
							if (userChoice == JFileChooser.APPROVE_OPTION) {
								...
								Caesar caesar = new Caesar();
								try {
									caesar.decryptFile(textFile, key, destDir);
